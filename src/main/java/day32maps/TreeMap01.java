...
public class TreeMap01 {
    ...
    /*
        1) TreeMAp ler entrySet leri keylere gore natural order da siralar.
    ...
    public static void main(String[] args) {
        ...
        // tailMap(String, false) verilen keyden baslayarak sona kadar tum entryleri size verir.
        // ama sizin verdiginiz keyi haric tutar.
        ...
        // lowerEntry("Paris Hilton"); paris hiltondan bir oncesini verir paris hilton olmasa da
        // sanki varm,is gibi davranir ve olsaydi hangi siralama olurdu diye hesaplar.
        Map.Entry<String,Double> map5 = salaries.lowerEntry("Paris Hilton");
        System.out.println(map5);// Mary Star=1000.0

        // higherEntry("Mary Star"); maryden bir sonrasini verir.
        // note : methodlar oncesinde veya sonrasinda bir sey yoksa null verir.
        ...
        System.out.println(map7);// null ==> cunku tomdan sonra eleman yok

        // ceilingEntry var olan key ile kullanilirsa o keyi verir. var olamayan bir key ile kullanilirsa
        // bir sonrakini verir.
