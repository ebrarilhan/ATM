...
public enum UsStates {
    ...
    public static String getStateNameFromAbbreviation(String abbreviation){
        ...
        return Arrays.
                stream(values()).filter(UsStates->UsStates.getAbbreviation().equals(abbreviation)).
                findFirst().
                get().
                getStateName();
    ...
    //example 1: baskenti verilen statein kisaltmasini ekrana yazdiran methodu olusturunuz.
